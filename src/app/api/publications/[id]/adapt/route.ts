...
const LIMITS: Record<string, string> = {
  ...
  threads: "Threads: СТРОГО до 500 символов (это лимит символов, не слов). Текст обязан быть законченной самодостаточной мыслью — НИКОГДА не обрывай предложение или идею на середине. Если смысл не помещается — сократи и переформулируй так, чтобы мысль была полностью завершена в пределах 500 символов. Разговорный тон, 0-2 хэштега.",
};
